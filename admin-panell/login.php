...
include "code/check-user-login.php";
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <span style="color:#FF0000;"><?php echo  $loginFailMsg; ?> </span>
                                    ...
                                    <form action="login.php"  method="post" name="login-form" id="login-form">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" value="" name="user-email">
                                        </div>
                                        <div class="mb-3">
                                            <label class="mb-1"><strong>Password</strong></label>
                                            <input type="password" class="form-control" value="" name="user-password">
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <input type="submit" class="btn btn-primary btn-block" value="Sign Me In" name="submit">
                                        </div>
                                    </form>
