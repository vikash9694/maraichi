        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">Menu List</h4>
					<div>
					<a href="new-menu.php" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Menu</a>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="table-responsive">
							<table class="table display mb-4 dataTablesCard Menu-table table-responsive-xl card-table" id="example5">
								<thead>
									<tr>
										<th>id</th>
										<th>page_name</th>
								...
								<tbody>
									...
									<tr>
										...
										<td><span class="badge <?php if($row['status']=='active'){ echo 'badge-success';}else{ echo 'badge-danger'; }?>  badge-lg light"><?php echo $row['status'];?></span></td>
										...
										<td>
											<div class="action-buttons d-flex justify-content-end">
												...
												<a href="new-menu.php?id=<?php echo $row['id'];?>" class="btn btn-secondary light mr-2">
												...
												<a href="menu-list.php?id=<?php echo $row['id'];?>" class="btn btn-danger light">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"></rect>
